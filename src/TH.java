...
public class TH
{
	...
	private static void setValues(PreparedStatement preparedStmt, String[] splitted, int THID, String URL) throws SQLException, IOException
	{
		...
		try
		{
			...
			exectueStmt(preparedStmt, splitted);
		}
		catch(Exception e)
		{
			System.out.println("an inputed value did not match specifications of what is needed. try again");
	...
	private static void exectueStmt(PreparedStatement preparedStmt, String[] splitted) throws SQLException, IOException
	{
		try
		{
			preparedStmt.execute();
			System.out.println("TH created with THID " + splitted[0]);
		}
