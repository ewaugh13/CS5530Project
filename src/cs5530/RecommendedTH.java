...
public class RecommendedTH {
	...
	public String getRecommendedTH(int THID, Statement stmt) throws SQLException, IOException
	{
		...
		return "Based on your Reservation of " + THID + ", here are some other Temporary Houses you might be interested in. \n" + output;
	}
